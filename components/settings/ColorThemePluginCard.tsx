    ...
    <div className="rounded-[var(--radius)] border border-[var(--color-accent)]/30 bg-[var(--color-bg-primary)] overflow-hidden">
      ...
      <div className="px-4 pb-4 pt-1 border-t border-[var(--color-border)]">
        <div className="pt-4 space-y-3">
          <div className="grid grid-cols-4 gap-2">
            {COLOR_PRESETS.map((p) => (
              <button
                ...
                className={`flex flex-col items-center gap-2 p-3 rounded-[var(--radius)] active:scale-[0.92] transition-[color,transform,box-shadow] duration-[var(--duration-fast)]
          ...
          <div
            className={`flex items-center gap-3 px-3 py-3 rounded-[var(--radius)] active:scale-[0.92] transition-[color,transform,box-shadow] duration-[var(--duration-fast)]
