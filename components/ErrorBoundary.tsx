  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[200px] p-8 text-center">
      <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[var(--color-bg-tertiary)] mb-4">
        <svg className="w-[18px] h-[18px] text-[var(--color-text-tertiary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <button
        onClick={onRetry}
        className="mt-4 px-5 py-2.5 text-[13px] min-h-[44px] flex items-center rounded-[var(--radius)] bg-[var(--color-bg-tertiary)] text-[var(--color-text-secondary)] hover:bg-[var(--color-bg-secondary)] hover:text-[var(--color-text-primary)] active:scale-[0.92] transition-colors duration-100"
      >
        {t("common.errorRetry")}
      </button>
    </div>
