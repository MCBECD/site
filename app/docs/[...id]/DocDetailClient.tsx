      ...
      <div className="doc-glass-card overflow-hidden detail-enter">
        ...
        <div className="flex items-center justify-between h-12 px-3 sm:px-5 border-b border-[var(--color-border-light)]">
          <div className="flex items-center gap-2">
            <Link
              href="/docs/"
              className="inline-flex items-center gap-1.5 text-[13px] text-[var(--color-text-secondary)] hover:bg-[var(--color-bg-tertiary)] hover:text-[var(--color-text-primary)] active:scale-[0.92] transition-colors duration-[var(--duration-fast)] no-underline min-h-[44px]"
            >
